...
class LLMModel():
    def __init__(self, folder_path: str, sep: str = " ", ch_size: int = 1024):
        ...
        # Замените метод создания SSL контекста на версию без проверки сертификата
        ...
        # Вносим patch в create_ssl_context используемый в httpx
        with patch('httpx._config.create_ssl_context', new=patched_create_ssl_context):
            from langchain_openai import OpenAIEmbeddings
